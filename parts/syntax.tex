...
Thiguka does not distinguish alienability in posession, \emph{-pafay} is akin to English \emph{-'s}.
The noun being posessed comes after the posessor.

\ex
\begingl
    \gla  Thaka-pafay  kaela-gula//
    \glb  1SG-GEN.POSS tree-DU//
    \glft `My two trees'//
\endgl
\xe
